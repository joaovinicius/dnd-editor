...
export default function Navbar({ phone = '1-833-662-8550' }: NavbarProps) {
  ...
  return (
    <nav className={`flex justify-between items-center sticky top-0 py-4 px-vw-1 left-0 right-0 z-50 transition-all min-h-20 duration-500 text-black ${isScrolled ? 'bg-white' : 'bg-red-300'}`}>
      <h1>LOGO</h1>
